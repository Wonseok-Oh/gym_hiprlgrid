...
class MultiHiPRLGridPoseV0(MiniGridEnv):
    """
    ...
    class Agent(object):
        def __init__(self, id, multihiprlgridposev0):
            self.multihiprlgridposev0 = multihiprlgridposev0
            self.mode = self.multihiprlgridposev0.Option_mode.init
            self.pos = None
            self.prev_pos = None
            self.dir = None
            self.prev_dir = None
...
#                self.navigation_map_pub.publish(self.agents[i].map)
    ...
    def process_action_effect(self, item):
        ...
        try:
            ...
            return False   
register(
    id='MiniGrid-MultiHiPRLGridPose-v0',
    entry_point='gym_minigrid.envs:MultiHiPRLGridPoseV0'
)
